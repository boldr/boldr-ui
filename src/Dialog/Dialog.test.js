...
describe('Dialog component', () => {
  ...
  it('should render a dialog in body when `visible` is true', () => {
    ...
    expect(document.querySelector('.boldrui-dialog-r-anchor').parentNode).toBe(document.body);
  });
  ...
  it('can have no title', () => {
    ...
    open();
    expect(document.querySelectorAll('.boldrui-dialog-r-header').length).toBe(0);
  });
  ...
  it('can have no mask', () => {
    ...
    open();
    expect(document.querySelectorAll('.boldrui-dialog-r-backdrop').length).toBe(0);
  });

  it('has mask', () => {
    open();
    expect(document.querySelectorAll('.boldrui-dialog-r-wrap').length).toBe(1);

    const mask = document.querySelector('.boldrui-dialog-r-wrap');
    Simulate.click(mask);
    jest.runOnlyPendingTimers();
    expect(document.querySelectorAll('.boldrui-dialog-r-wrap').length).toBe(0);
  });
