...
const CenterArrowPosition = {
  ...(() => {
    const make = (getX, side) =>
      Position.create((anchorBoundingBox, containerBoundingBox, contentDimension, options) => {
    ...
    return {
      ...
      TopRight: make(
        (middle, contentDimension) => middle - (contentDimension.width - ARROW_OFFSET),
        'right',
      ),
    };
  })(),
  ...
  ...(() => {
    ...
    return {
      ...
      LeftBottom: make(
        (middle, contentDimension) => middle - (contentDimension.height - ARROW_OFFSET),
        'bottom',
      ),
    };
  })(),
