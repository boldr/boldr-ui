...
describe('<BubbleList />', () => {
  ...
  it('prop [direction=down]', () => {
    const context = { muiTheme };
    const wrapper = shallow(<BubbleList isOpen direction="down" />, {
      context,
    });
  ...
  it('prop [direction=right]', () => {
    const context = { muiTheme };
    const wrapper = shallow(<BubbleList isOpen direction="right" />, {
      context,
    });
  ...
  it('prop [direction=left]', () => {
    const context = { muiTheme };
    const wrapper = shallow(<BubbleList isOpen direction="left" />, {
      context,
    });
  ...
  it('prop [alignment=down]', () => {
    const context = { muiTheme };
    const wrapper = shallow(<BubbleList isOpen alignment="down" />, {
      context,
    });
    expect(getStylesFromShallowNode(wrapper).top).toEqual('0');
  });
  ...
  it('prop [alignment=right]', () => {
    const context = { muiTheme };
    const wrapper = shallow(<BubbleList isOpen alignment="right" />, {
      context,
    });
    expect(getStylesFromShallowNode(wrapper).right).toEqual('0');
  ...
  it('prop [alignment=left]', () => {
    const context = { muiTheme };
    const wrapper = shallow(<BubbleList isOpen alignment="left" />, {
      context,
    });
    expect(getStylesFromShallowNode(wrapper).left).toEqual('0');
