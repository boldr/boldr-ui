...
import muiTheme from '../../../../internal/jest/contextMuiTheme';
import getDomFromString
  from '../../../../internal/jest/utils/get-dom-from-string';
import getStylesFromShallowNode
  from '../../../../internal/jest/utils/get-styles-from-shallow-node';
...
describe('<BubbleListItem />', () => {
  ...
  it('renders *primary text*', () => {
    const wrapper = shallow(<BubbleListItem primaryText="Hello world!" />, {
      context,
    });
  ...
  it('with prop *href* renders a "a" tag with href attribute', () => {
    const wrapper = shallow(
      <BubbleListItem href="/" primaryText="Hello world!" />,
      { context },
    );
  ...
  it('with prop *isOpen = false* has opacity=0', () => {
    const wrapper = shallow(
      <BubbleListItem isOpen={false} primaryText="Hello world!" />,
      { context },
    );
  ...
  it('with prop *isOpen = true* has opacity=1', () => {
    const wrapper = shallow(
      <BubbleListItem isOpen primaryText="Hello world!" />,
      { context },
    );
  ...
  it('find className', () => {
    const wrapper = shallow(<BubbleListItem className="m-bubble-list-item" />, {
      context,
    });
  ...
  it('simulate onTouchTap', () => {
    ...
    const wrapper = shallow(
      <BubbleListItem primaryText="Hello world!" onTouchTap={onButtonClick} />,
      { context },
    );
  ...
  it('simulate onClick', () => {
    const onButtonClick = sinon.spy();
    const wrapper = shallow(
      <BubbleListItem primaryText="Hello world!" onClick={onButtonClick} />,
      { context },
    );
    wrapper.find('a').simulate('touchTap');
    expect(onButtonClick.calledOnce).toEqual(true);
  ...
  it('on keyUp enter onClick | onTouchTap is fired', () => {
    ...
    const wrapper = shallow(
      <BubbleListItem primaryText="Hello world!" onClick={onKeyUp} />,
      { context },
    );
    wrapper.setState({
  ...
  it('simulate onFocus', () => {
    ...
    const wrapper = shallow(
      <BubbleListItem primaryText="Hello world!" onFocus={onFocus} />,
      { context },
    );
  ...
  it('simulate onBlur', () => {
    ...
    const wrapper = shallow(
      <BubbleListItem primaryText="Hello world!" onBlur={onBlur} />,
      { context },
    );
  ...
  it('tabIndex for href link should be 2 if open', () => {
    ...
    expect(
      getDomFromString(wrapper.find('a').html()).getAttribute('tabindex'),
    ).toEqual('2');
  });

  it('tabIndex for href link should be 1 if open', () => {
    const wrapper = shallow(
      <BubbleListItem isOpen href="/" primaryText="Hello world!" />,
      { context },
    );
    expect(
      getDomFromString(wrapper.find('a').html()).getAttribute('tabindex'),
