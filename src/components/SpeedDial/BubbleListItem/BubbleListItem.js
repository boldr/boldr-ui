...
import propTypes from './BubbleListItem.propTypes';
import defaultProps from './BubbleListItem.defaultProps';
import getStyles from './BubbleListItem.styles';
