...
describe('Radio Section', () => {
  ...
  it('Radio will render default structure without any props', () => {
    ...
    expect(wrapper.hasClass('boldrui-radio-wrap')).toBe(true);
    ...
    expect(
      wrapper.find('.boldrui-radio').childAt(0).hasClass('boldrui-radio-inner'),
    ).toBe(true);
    expect(wrapper.find('.boldrui-radio').childAt(1).type()).toBe('input');
    expect(wrapper.find('.boldrui-radio').childAt(1).props().type).toBe(
      'radio',
    );
  });
  ...
  it('Radio can have custom className, prefix and children', () => {
    const wrapper = shallow(
      <Radio className="foo" prefix="bar">
        <span className="boldrui-radio-children" />
      </Radio>,
    );
    ...
    expect(wrapper.find('.boldrui-radio-children').length).toBe(1);
  });
  ...
  it('Radio can have independent disable and readOnly state', () => {
    ...
    expect(wrapperD.hasClass('boldrui-radio-disabled')).toBe(true);
    expect(wrapperR.hasClass('boldrui-radio-disabled')).toBe(true);
  ...
  it('Radio have independent checked prop (can be number or boolean)', () => {
    ...
    expect(wrapper.hasClass('boldrui-radio-checked')).toBe(true);
  ...
  it('Radio can have custom style which loaded on wrapper', () => {
    ...
    expect(wrapper.find('.boldrui-radio-wrap').props().style).toBe(styleObj);
  });
...
describe('RadioGroup Section', () => {
  it('RadioGroup will render an empty div without any children', () => {
    ...
    expect(
      wrapper.contains(<div className="boldrui-radio-group" style={{}} />),
    ).toBe(true);
  });
