...
const findComponent = ComponentToFind =>
  children => {
...
export class Nav extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <NavItemStyled className="boldrui-sidenav__item" { ...itemProps }>
          <NavIconCont>
        ...
        >
          {Children.toArray(children)
            ...
            .map((child, idx) => {
              ...
              const isItemHighlighted = highlightedId ===
                `${id}/${child.props.id}`;

              return (
                <NavItemStyled
                  className={ 'boldrui-sidenav__item-child' }
                  key={ idx }
                  { ...itemProps }
