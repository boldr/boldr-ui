...
describe('Controlled CheckboxGroup', () => {
  it('value', () => {
    ...
    expect(appleCheckboxNode.className).toContain('boldrui-checkbox__checked');
    expect(appleCheckboxInputNode.checked).toBe(true);

    expect(bananaCheckboxNode.className).not.toContain('boldrui-checkbox__checked');
  ...
  describe('disabled', () => {
    it('disabled group', () => {
      ...
      expect(appleCheckboxNode.className).toContain('boldrui-checkbox__disabled');
      expect(bananaCheckboxNode.className).toContain('boldrui-checkbox__disabled');
    ...
    it('checkbox disabled in group', () => {
      ...
      expect(appleCheckboxNode.className).toContain('boldrui-checkbox__disabled');
      expect(bananaCheckboxNode.className).not.toContain('boldrui-checkbox__disabled');
    ...
    it('checkbox not disabled in disabled group', () => {
      ...
      expect(appleCheckboxNode.className).not.toContain('boldrui-checkbox__disabled');
      expect(bananaCheckboxNode.className).toContain('boldrui-checkbox__disabled');
  ...
  it('className', () => {
    ...
    expect(radioGroupNode.className).toContain('boldrui-checkbox__group');
  });
  ...
  it('prefix', () => {
    ...
    expect(radioGroupNode.className).not.toContain('boldrui-checkbox__group');
    expect(radioGroupNode.className).toContain('custom-checkbox__group');

    expect(radioNode.className).toContain('boldrui-checkbox__wrap');
    expect(radioNode.className).not.toContain('custom-checkbox__wrap');
  });
});
