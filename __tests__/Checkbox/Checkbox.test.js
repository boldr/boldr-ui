...
describe('Controlled Checkbox', () => {
  it('checked', () => {
    ...
    expect(checkboxNode.className).toContain('boldrui-checkbox__checked');
  });
  ...
  it('unchecked', () => {
    ...
    const checkboxNode = ReactDOM.findDOMNode(checkbox);
    expect(checkboxNode.className).not.toContain('boldrui-checkbox__checked');
  });
  ...
  it('disabled', () => {
    ...
    const checkboxNode = ReactDOM.findDOMNode(checkbox);
    expect(checkboxNode.className).toContain('boldrui-checkbox__disabled');
  });
  ...
  it('indeterminate', () => {
    ...
    const checkboxNode = ReactDOM.findDOMNode(checkbox);
    expect(checkboxNode.className).toContain('boldrui-checkbox__indeterminate');
  });
  ...
  it('prefix', () => {
    ...
    expect(checkboxNode.className).not.toContain('boldrui-checkbox__wrap');
    expect(checkboxNode.className).toContain('custom-checkbox__wrap');
